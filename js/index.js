(function() {
    ...
    var Game = React.createClass({displayName: 'Game',
        ...
        render: function() {
            return React.DOM.div(null,
                ...
                Menu({winClass: this.state.win ? 'button win' : 'button', status: this.state.win ? 'Je hebt gewonnen! Neem deze code mee naar het Game event: 3845!' : 'Los jij de puzzel op?', restart: this.restartGame})
            );
        }
    });
    ...
    var Tile = React.createClass({displayName: 'Tile',
        ...
        render: function() {
            return React.DOM.div({className: "tile", id:"id_"+this.props.status, onTap: this.clickHandler, onClick: this.clickHandler}, this.props.status);
        }
    });
    ...
    var Menu = React.createClass({displayName: 'Menu',
        ...
        render: function() {
            return React.DOM.div({id: "menu"},
                ...
                React.DOM.a({className: this.props.winClass, onTap: this.clickHandler, onClick: this.clickHandler}, "Restart")
            );
        }
    });
